...
| Watchlist goes stale as businesses drift | roughly weekly owner-initiated candidate refresh using deterioration evidence; bench list in watchlist.yaml comments; cache pruning cleans up dropped names automatically |
