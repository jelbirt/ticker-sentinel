...
- Serialized shared state: `data/cache/` is written by the scheduled Actions job, which commits to main daily; the bot holds the pen (registry: `tasks/todo.md`). Never modify `data/cache/` on a workstream branch.
